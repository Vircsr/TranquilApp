...
//初始化播放封面和歌词页面
    private void initViewPager() {
        ...
        mAlbumCoverView = coverView.findViewById(R.id.album_cover_view);//封面
        mLrcViewSingle = coverView.findViewById(R.id.lrc_view_single);//歌手
        mLrcViewFull = lrcView.findViewById(R.id.lrc_view_full);//歌词界面
        sbVolume = lrcView.findViewById(R.id.sb_volume);//音量
        mAlbumCoverView.initNeedle(AudioPlayer.get().isPlaying());//封面初始化
        mLrcViewFull.setOnPlayClickListener(this);//歌词监听
        initVolume();
